...
let myAge = 15;
console.log(myAge > 18 ? "I predict True." : "I predict false.");

let myFavouriteteacherName = "Zia";
console.log(
  myFavouriteteacherName == "Zia" ? "I predict True." : "I predict false."
);

let gateColor = "white";
console.log(gateColor == "pink" ? "I predict True." : "I predict false.");

let myFavouriteFlower = "rose";
console.log(
  myFavouriteFlower == "rose" ? "I predict True." : "I predict false."
);
